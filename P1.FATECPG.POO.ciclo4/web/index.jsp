...
<%@page import="p1.poo.fatecpg.ads.noitr.Disciplinas"%>
...
<html>
    ...
    <body>
        ...
        <p>Matérias Matriculadas: <%=listaDisciplinas.getList().size()%> </p>
    </body>
</html>
